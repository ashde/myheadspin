...
def run(host):
    ...
    with open('/dev/null', 'w') as devnull:
        # print(host + " ++ DEUBG ++ " )
        out = subprocess.check_output(['ssh', '-F', '/Users/ash/headspinio/keys-red/dev/ssh-config', '-o', 'BatchMode=yes', '-o', 'UserKnownHostsFile=/dev/null', '-o', 'StrictHostKeyChecking=no', host, 'sw_vers -productVersion'], stderr=devnull)
